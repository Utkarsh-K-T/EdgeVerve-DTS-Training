        ...
        do 
        {
            ...
            switch (choice) 
            {
                ...
                case 6:
                    ...
                    sc.nextLine();
                    Student foundStudent = dao.findStudentByIdUsingProc(findId);
                    System.out.println(foundStudent != null ? foundStudent : "Student not found");
                    break;
                    
                case 7:
                	dao.connect();
                    int topperMarks = dao.findTopperMarksUsingFunc();
                    String topperName = dao.findTopperNameUsingFunc();
                    System.out.println("Topper Student: " + topperName + " with Marks: " + topperMarks);
                    break;
